...
public class CoinoneCandleService {
    ...
    public List<CryptoVolume> getCandlesBySymbolAndTime(String symbol) {
        ...
        return coinoneCandleRepository.findVolumeBySymbolAndTimeRange(symbol, CandleAnalysisTime.Volume_START_TIME_STAMP.getTime(), CandleAnalysisTime.Volume_END_TIME_STAMP.getTime());
    }
