...
public enum CandleAnalysisTime {
    ...
    RSI_START_TIME_STAMP(LocalDateTime.now().minusMinutes(11L).toEpochSecond(ZoneOffset.UTC) * 1000),
    RSI_END_TIME_STAMP(LocalDateTime.now().minusMinutes(2L).toEpochSecond(ZoneOffset.UTC) * 1000),
