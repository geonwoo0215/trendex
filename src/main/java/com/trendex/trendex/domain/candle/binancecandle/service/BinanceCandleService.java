...
public class BinanceCandleService {
    ...
    public List<CryptoVolume> getCandlesBySymbolAndTime(String symbol) {
        ...
        return binanceCandleRepository.findVolumeBySymbolAndTimeRange(symbol, CandleAnalysisTime.STAR_TIME_STAMP.getTime(), CandleAnalysisTime.END_TIME_STAMP.getTime());
    }
