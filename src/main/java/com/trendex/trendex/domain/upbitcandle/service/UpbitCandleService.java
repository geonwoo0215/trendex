...
import com.trendex.trendex.domain.upbitcandle.repository.UpbitCandleJdbcRepository;
import com.trendex.trendex.domain.upbitcandle.repository.UpbitCandleRepository;
...
public class UpbitCandleService {
    ...
    @Transactional(readOnly = true)
    public List<CryptoClosePrice> getClosePricesByMarketAndTime(String market, long timestamp) {
