...
public class UpbitTrade {
    ...
    public UpbitTrade(String market, String tradeDateUtc, String tradeTimeUtc, long timestamp, long tradePrice, double tradeVolume, long prevClosingPrice, long changePrice, String askBid) {
        this.market = market;
